...
# Next steps
The data is now clean and ready for analysis. I have put a .csv of these data in `\data\clean`
  
A few ideas for descriptive analysis:
  
1. Total time spoken (calculate time per line using timestamps)
2. Total times interrupted (search for strings at end of lines that suggest this...no period?)
3. Most common words used
4. Sentiment analysis via `syuzhet` package?
5. Plot these by speaker/time?